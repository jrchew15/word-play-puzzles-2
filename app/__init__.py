...
from .api.wordle_routes import wordle_routes
...
app = Flask(__name__, static_folder='../word-play-ts/build', static_url_path='/')
...
app.register_blueprint(wordle_routes, url_prefix='/api/wordles')
db.init_app(app)
Migrate(app, db)
